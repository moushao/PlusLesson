...
public class SportsView extends View {
    private static final float RING_WIDTH = DPUtils.dp2px(20);
    ...
    {
        paint.setTextSize(DPUtils.dp2px(100));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(getWidth() / 2 - RADIUS, getHeight() / 2 - RADIUS, getWidth() / 2 + RADIUS, getHeight() / 2 + RADIUS, 0, 225, false, paint);
